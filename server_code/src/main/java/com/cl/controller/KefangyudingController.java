...
public class KefangyudingController {
    ...
    public R page(@RequestParam Map<String, Object> params,KefangyudingEntity kefangyuding,
		...
		if(tableName.equals("kefangbu")) {
			kefangyuding.setKefangbuzhanghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
		...
		if(tableName.equals("kefangbu")) {
            ew.eq("kefangbuzhanghao", (String)request.getSession().getAttribute("username"));
		}
