<template>
	<div class="home">
		<div class="index_top">
			<div class="index_top_title">民宿酒店管理和设计系统的实现</div>
...
<script setup>
	...
	const getSession = () =>{
		context?.$http({
			...
			if(context?.$toolUtil.storageGet('frontSessionTable') == 'canyinbu'){
				context?.$toolUtil.storageSet("frontName", res.data.data.canyinbuzhanghao)
			}
			if(context?.$toolUtil.storageGet('frontSessionTable') == 'canyinbu'){
				context?.$toolUtil.storageSet('headportrait',res.data.data.touxiang)
			}
			if(context?.$toolUtil.storageGet('frontSessionTable') == 'kefangbu'){
				context?.$toolUtil.storageSet("frontName", res.data.data.kefangbuzhanghao)
			}
			if(context?.$toolUtil.storageGet('frontSessionTable') == 'kefangbu'){
				context?.$toolUtil.storageSet('headportrait',res.data.data.touxiang)
			}
			if(context?.$toolUtil.storageGet('frontSessionTable') == 'caiwubu'){
				context?.$toolUtil.storageSet("frontName", res.data.data.caiwuzhanghao)
			}
			if(context?.$toolUtil.storageGet('frontSessionTable') == 'caiwubu'){
				context?.$toolUtil.storageSet('headportrait',res.data.data.touxiang)
			}
